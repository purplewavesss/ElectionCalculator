...
class UiMainWindow(object):
    def setup_ui(self, main_window):
        ...
        self.party_table = QtWidgets.QTableWidget(self.central_widget)
        self.party_table.setGeometry(QtCore.QRect(10, 10, 410, 320))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.party_table.setFont(font)
        self.party_table.setObjectName("party_table")
        self.party_table.setColumnCount(5)
        self.party_table.setRowCount(1)
        item = QtWidgets.QTableWidgetItem()
        self.party_table.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        self.party_table.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.party_table.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.party_table.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.party_table.setItem(0, 3, item)
        item = QtWidgets.QTableWidgetItem()
        self.party_table.setItem(0, 4, item)
        self.party_table.horizontalHeader().setVisible(False)
        self.party_table.horizontalHeader().setDefaultSectionSize(80)
        self.party_table.verticalHeader().setVisible(False)
        self.party_table.verticalHeader().setDefaultSectionSize(35)
        self.party_table.verticalHeader().setHighlightSections(False)
        self.party_table.verticalHeader().setMinimumSectionSize(35)
        self.append_party_table = QtWidgets.QTableWidget(self.central_widget)
        self.append_party_table.setGeometry(QtCore.QRect(10, 340, 250, 40))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.append_party_table.setFont(font)
        self.append_party_table.setObjectName("append_party_table")
        self.append_party_table.setColumnCount(3)
        self.append_party_table.setRowCount(1)
        item = QtWidgets.QTableWidgetItem()
        self.append_party_table.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.append_party_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.append_party_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.append_party_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.append_party_table.setItem(0, 1, item)
        self.append_party_table.horizontalHeader().setVisible(False)
        self.append_party_table.horizontalHeader().setDefaultSectionSize(80)
        self.append_party_table.horizontalHeader().setHighlightSections(False)
        self.append_party_table.horizontalHeader().setMinimumSectionSize(45)
        self.append_party_table.verticalHeader().setVisible(False)
        self.append_party_table.verticalHeader().setDefaultSectionSize(35)
        self.append_party_table.verticalHeader().setHighlightSections(False)
    ...
    def retranslate_ui(self, main_window):
        ...
        item = self.party_table.verticalHeaderItem(0)
